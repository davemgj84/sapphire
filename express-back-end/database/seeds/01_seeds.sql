...
VALUES
  ...
  (5, 'scene 5, dialogue 30 AHA! There -- in the rubble! You spot a tiny, concrete monkey fist, rising victorously from the rubble. This feels like a fever dream but you know, deep down, it''s real. Just to be certain, you reach toward the monkey arm to feel it and for a moment, you and the monkey are like God and Adam in that Michaelangelo painting on the Sistine Chapel. Time to return the sapphire shards to their rightful destination...' ),
