...
VALUES
  ...
  (2, 'scene 2, dialogue 7 On the brink of giving up, you are shocked to discover a person dressed in robes covered in strange symbols. It occurs to you that you don''t actually know what an alchemist is, but your intuition tells you this free spirit must be one.'),
  ...
  (2, 'scene 2, dialogue 11 GLORY BE! A small oasis is revealed in the heart of the shifting sands -- and -- on a pedestal in the water, a shining sapphire shard glimmer blue against the blazing orange hirizon. Your cycnical mind cannot compute this obvious wizardry but you are singularly focused on the Sapphire Monkey and choose to ignore it. Triumphantly, you return to the alchemist who instructs you to seek out a friend of his, the hunter. He suspects they might have pertinent info on one of the sapphire shards.'),

  -- Scene3
  (3, 'scene 3, dialogue 12 - You walk for hours through the great plains, the prairie dogs and mosquitos your only companions. Seeing wildlife for the first time in many years gives you a sense of hope which is overshaddowed by the doom of sweeping vacancy. You wonder if you''ve gone in the right direction when you stumble upon a small camp. Nobody is home and you are feeling rife with nosiness. You pick through the hunter''s belongings for clues.'),
  ...
  (4, 'scene 4, dialogue 21 - ...You run smack-dab into the tallest tree you''ve ever seen. To be fair, Zoomieville doesn''t have trees, but you''ve seen them in movies so you KNOW this is a big''un. Looking around, you dont see a soul, not even a hermit, when suddenly you hear a faint squeaking sound and look down...'),
  ...
  (4, 'scene 4, dialogue 26 - The snail eats the herbs you lay in front of her and -- like a phoenix rising from the ashes - she is transformed to her former humanly form! "Flabberghasted"? "Bewildered"? You can''t quite grasp the appropriate word to describe your current mental state. You think, "Maybe I do believe in spookums, afterall." The snail-woman thanks you and asks if there is anything she can do for you on your journey?'),
  ...
  (5, 'scene 5, dialogue 35 Oh, ZUT ALORS! That boulder chase made you forget everything! You did not find all of the sapphires and fursiouly, you begin to wonder aloud: "What am I doing here!? What is life!? Where are my Doritos!?" Maybe that "wise guy" wasn''t so wise afterall...'),
