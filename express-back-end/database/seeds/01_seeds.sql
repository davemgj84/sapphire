...
INSERT INTO dialogues
  (scene_id, story)
VALUES
  (1, 'scene 1, dialogue 1 You step outside to buy Doritos from the convenience store in the desolate town of Zoomieville. Things have become increasingly bleak as scientists have predicted the end of the world is near, so you''ve taken to tending to an ant farm to pass the time and keep your mind busy.'),
  (1, 'scene 1, dialogue 2 OLD MAN: "I am old and I am a man and therefore, I am wise. Listen to me, kid!" You are startled by his blunt approach, but Wheel of Fortune isn''t on until 5 and so you decide it might be interesting to hear him out.'),
  ...
  (2, 'scene 2, dialogue 7 On the brink of giving up, you are shocked to discover a person dressed in robes covered in strange symbols. It occurs to you that you don''t actually know what an alchemist is, but your intuition tells you this hippie must be one.'),
  (2, 'scene 2, dialogue 8 ALCHEMIST: "There''s a small shard of sapphire lost in the desert sands. Each morning, the sands shift, making it increasingly difficult to locate. I''ve become too slow to find it on my own. TAKE MY MAP! Follow the arrows to discover what you desire." [type the arrows that appear on the screen before time runs out!]'),
  ...
  (2, 'scene 2, dialogue 10 You return from your day of aimlessly rolling around in the sand, doubt and defeat overcome you because you''ve failed in your task. As you search for the alchemist, you notice he''s gone. All he''s left behind is a McDonald''s bag. From the receipt, you discover that his name is actually Andy and he ordered a BigMac and fries. Weird. You eat a sad, cold fry abandoned at the bottom of the bag and decide it''s high time to move on. What does Andy know, anyway? You shrug and wander off toward the horizon.'),
  (2, 'scene 2, dialogue 11 RAZZLE DAZZLE! A small oasis is revealed in the heart of the shifting sands -- and -- on a pedestal in the water, a shining sapphire shard glimmers blue against the blazing orange horizon. Your cynical mind cannot compute this obvious wizardry but you are singularly focused on the Sapphire Monkey and choose to ignore it. Triumphantly, you return to the alchemist who instructs you to seek out a friend of his, the hunter. He suspects they might have pertinent info on one of the sapphire shards.'),

  -- Scene3
  (3, 'scene 3, dialogue 12 - You walk for hours through the great plains, the prairie dogs and mosquitos your only companions. Seeing wildlife for the first time in many years gives you a sense of hope which is overshadowed by the doom of sweeping vacancy. You wonder if you''ve gone in the right direction when you stumble upon a small camp. Nobody is home and you are feeling rife with nosiness. You pick through the hunter''s belongings for clues.'),
  (3, 'scene 3, dialogue 13 - HUNTER: "WHO IN THE NAME OF TIM HORTON DO YOU THINK YOU ARE!?" -- she points her bow and arrow at you and shoots you with her stink eye, but does not release the real arrow. WHEW!'),
  (3, 'scene 3, dialogue 14 - You consider telling her that you *think* you are Tom Hanks -- but decide against it -- in favor of explaining to her that the alchemist sent you because you are on a quest to find and return sapphire shards the legendary Sapphire Monkey. She lowers her bow.'),
  (3, 'scene 3, dialogue 15 HUNTER: "The alchemist? Isn''t he dreamy?" You aren''t sure if she means this literally or figuratively but nod your head yes regardless to garner her trust. HUNTER: "I will help only if you can answer this riddle... ~*~*This old one runs forever, but never moves at all. They have not lungs nor throat, but still a mighty roaring call. What is it?*~*~'),
  (3, 'scene 3, dialogue 16 HUNTER: "HOT DOG! That is the correct answer. I will show you to the waterfall where you will find the shard buried under a gnome hut. From there you, must travel to the enchanted forest and find the hermit near the great tree. They might know where the last shard remains..."'),
  ...
  (3, 'scene 3, dialogue 18 HUNTER: "You took the slow train, but you still arrived -- That is the correct answer! Follow me to the waterfall where you will find the shard buried under a gnome hut. From there you must travel to the enchanted forest and find the hermit near the GIANT tree. Like, really, really big. Please don''t miss it. The hermit might know where the last shard remains."'),
  (3, 'scene 3, dialogue 19 "WRONG!" The hunter scoffs... "IT''S A WATERFALL, Einstein! And here -- take my cat! He doesn''t make as good of a bird dog as I''d hoped" You are confused by this strange person and decide to seek shelter in a nearby forest to hide. Maybe you aren''t a master riddler, but this cat is an unexpected perk to losing out on that sapphire. You call him Little Princess Artoo.'),

  --  Scene 4

  (4, 'scene 4, dialogue 20 - You slink along to the enchanted forest in search of the wise hermit, but your thoughts keep drifting to things like Tom Holland as Spiderman and Carly Rae Jepsen''s latest album drop. "BIG TREE", you tell yourself, trying to maintain focus, "GIANT!"..."UGE"..."THE BIGGEST" Your thoughts are clearly getting away from you and just as soon as you think you''ve lost it...'),
  (4, 'scene 4, dialogue 21 - ...You run smack-dab into the tallest tree you''ve ever seen. To be fair, Zoomieville doesn''t have trees, but you''ve seen them in movies so you KNOW this is a big''un. Looking around, you don''t see a soul, not even a hermit, when suddenly you hear a faint squeaking sound and look down...'),
  (4, 'scene 4, dialogue 22 - Near your feet, there is a MEDIUM SIZED snail. Not that small, but not that big... It can be firmly categorized as medium-sized. "SNAILS SQUEAK!?" you gasp aloud. You can''t make this stuff up.'),
  ...
  (4, 'scene 4, dialogue 25 - SNAIL: "SHORTY, YOU''RE MY ANGEL. YOU''RE MY DARLING ANGEL. THANK YOU!" In this moment, you realize she''s clearly been a snail since the turn of the century and decide it is best not to fill her in on the state of current affairs.'),
  (4, 'scene 4, dialogue 26 - The snail eats the herbs you lay in front of her and -- like a phoenix rising from the ashes - she is transformed to her former humanly form! "Flabbergasted"? "Bewildered"? You can''t quite grasp the appropriate word to describe your current mental state. You think, "Maybe I do believe in spookums, afterall." The snail-woman thanks you and asks if there is anything she can do for you on your journey?'),
  (4, 'scene 4, dialogue 27 - Mouth agape, you don''t have your wits about you so she removes her necklace and offers it to you... on it dangles the sapphire shard you seek. The snail-woman, enthusiastic about your quest (and her newfound body), directs you toward a path that leads to the ruins of the lost temple of the Sapphire Monkey.'),

  -- Scene 5

  (5, 'scene 5, dialogue 28 Holy monkey bananagrams, you are inside of the Sapphire Monkey Temple! It smells a little funny -- a small price to endure to save Mother Earth and all of her children. Honestly, you never thought you''d make it this far but you''re feeling #blessed about the quest.'),
  (5, 'scene 5, dialogue 29 Now, where in the name of Jimminy Cricket is that darn monkey? You search high and low to uncover this important shrine. You wish your mom was with you because she can always find the things you''ve misplaced around the house. She would know where to look...'),
  (5, 'scene 5, dialogue 30 AHA! There!!! You spot a tiny, concrete monkey fist, rising victorously from the rubble. This feels like a fever dream but you know, deep down, it''s real. Just to be certain, you reach toward the monkey arm to feel it and for a moment, you and the monkey are like God and Adam in that Michaelangelo painting on the Sistine Chapel. Time to return the sapphire shards to their rightful destination...' ),
  (5, 'scene 5, dialogue 31 OooOoOoOooOOoohhhh noOoOooOoooOO! You blink hard and ponder: "Is that a boulder rolling my way!?" To nobody in particular, you shout:  "RUN!" [press the A and S keys quickly on the next page to escape the boulder]'),
  ...
  (5, 'scene 5, dialogue 33 CLOSE CALL! Good thing you''re a speedy little gremlin! Now, back to monkey business...'),
  ...
  (5, 'scene 5, dialogue 35 Oh, ZUT ALORS! That boulder chase made you forget everything! You did not find all of the sapphires and fursiouly, you begin to wonder aloud: "What am I doing here!? What is life!? Where are my Doritos!?" Maybe that "wise guy" wasn''t so wise after all...'),
  ...
  (5, 'scene 5, dialogue 38 With a flick of the wrist, the sapphire monkey spreads restoration to the land. Like Molly Weasely, the Sapphire Monkey knows how use its magic to multitask and you watch with gratitude as it sets to work spinning up spells. Life rises up all around you.'),
  (5, 'scene 5, dialogue 39 YOU ARE A HERO OF OUR TIME! The sapphire monkey crowns you with rubies. But wait, there''s more. These aren''t regular rubies... Your eyes lock and you share the knowing...there is more to this adventure:  A quest for the RUBY ORANGUTAN!'),
